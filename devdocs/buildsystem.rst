...
* **EXTRA_RPM_REPOS** - extra repos with RPM packages.
  ...
  <first_repo_name>,<repo_path> <second_repo_name>,<second_repo_path> For
  example, qemu2,http://hostname.domain.tld/some/path/ libvirt,http://hostname.domain.tld/another/path/
