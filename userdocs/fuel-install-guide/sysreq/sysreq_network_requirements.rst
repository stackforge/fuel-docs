...
the OpenStack Bare Metal service. The Private network will appear
in  the default node network group if the environment networking segmentation
type is tunneling segmentation only.
