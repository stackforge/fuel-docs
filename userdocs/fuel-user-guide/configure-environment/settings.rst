      ...
      * - **General settings**
        - Access
          ...
          Repositories
           ...
           set up a local repository and provide the URL to the repository
           on this page.
          Kernel parameters
      ...
      * - **Security settings**
        - The :guilabel:`Public TLS` configuration includes:
          ...
          Restrict SSH service on network
           ...
           Fuel Master node IP.
           When disabled (by default), the admin, management, and storage
           networks can connect only to the SSH service.

          Restrict access to
           The option sets access restriction to the specified range
           of IP addresses.
