...
* **the Fuel UI URL:** change the IP address on the Fuel Setup installation
  stage.

* **the Fuel UI password:**

  * change the password you set on the Fuel Setup installation stage.
