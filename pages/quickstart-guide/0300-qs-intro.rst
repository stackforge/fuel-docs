...
You have the following options to deploy Fuel and the Mirantis 
OpenStack: 
...
* **Manual Installation**
  ...
  Mirantis recommends manual installation for evaluation only. Use 
  manual installation only if you cannot run the Mirantis VirtualBox 
