...
all slave nodes that you are going to use for the OpenStack
...
a PXE boot. If your nodes have serveral network interfaces,
...
booted in the network, you can create an OpenStack
