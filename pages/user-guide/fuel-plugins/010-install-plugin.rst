...
To view installed plugins open the *Plugins* tab in Fuel Web UI with
their versions, Mirantis OpenStack compatibility information, certification statuses, and providers' names.
