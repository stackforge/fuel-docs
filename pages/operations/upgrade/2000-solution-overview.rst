...
* :ref:`PSSH<https://code.google.com/p/parallel-ssh/>` – provides ability to run
  shell commands in parallel on multiple hosts.
* :ref:`PostgreSQL client
  <http://www.postgresql.org/docs/9.3/static/reference-client.html>` – required
