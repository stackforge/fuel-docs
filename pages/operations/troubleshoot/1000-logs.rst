...
The Fuel Master node log rotation template
is the /etc/logrotate.d/20-fuel-docker.conf file.
The template is called by /etc/cron.hourly/logrotate.
This ensures that the free space of /var/log is never exhausted.
