...
* *package_version* - version of plugin format; do not change it until
  ...
  this version in order to choose the way a plugin should be installed.
...
**fuel-plugin-builder** is located in `Fuel plugins repository <https://github.com/stackforge/fuel-plugins/tree/master/fuel_plugin_builder>`_


Are there any plugins examples?
+++++++++++++++++++++++++++++++

`Fuel plugins repository <https://github.com/stackforge/fuel-plugins>`_ has
