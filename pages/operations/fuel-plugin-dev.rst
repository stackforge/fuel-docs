...
Core plug-ins, GlusterFS and LBaaS Neutron, are kept in `fuel-plugins <https://github.com/stackforge/fuel-plugins>`_ repo. 

Experimental plug-ins are kept in `Mirantis fuel-plugins <https://github.com/Mirantis/fuel-plugins>`_ repo. Once plug-in is ready,
