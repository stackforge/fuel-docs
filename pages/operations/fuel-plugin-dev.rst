...
Meanwhile, Nailgun generates tasks from default **tasks.yaml** file for task executor
and parses **task.yaml** files to get the list of enabled plugins:
...
.. warning::
    ...
    To reuse existen puppet manifests you can also specify several puppet
