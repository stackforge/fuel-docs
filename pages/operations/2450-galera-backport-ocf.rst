...
#. Check that the Galera Cluster is fully assembled.  Status should be Primary;
   non-primary status indicates that the "split-brain" issue exists in the cluster:
   ::
