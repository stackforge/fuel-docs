...
which makes the Galera cluster more reliable and predictible.
...
#. The OCF script requires a bit modification
...
#. Configure the p_mysql resource for the new Galera OCF script
   ...
   .. note:: During this operation, the MySQL cluster will be restarted.
