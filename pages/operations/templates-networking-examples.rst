...
4. Save `network template for two networks
   <https://raw.githubusercontent.com/stackforge/fuel-docs/stable/7.0/examples/network_templates/two_networks.yaml>`_
...
4. Save `network template for one network
   <https://raw.githubusercontent.com/stackforge/fuel-docs/stable/7.0/examples/network_templates/one_network.yaml>`_
   as ``network_template_<env id>.yaml``.
