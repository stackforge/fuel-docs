...
Example of **environment_config.yaml** file, all possible Fuel web UI elements
are presented:
...
.. code-block:: yaml
    ...
    attributes:
      ...
      fuel_plugin_name_text:
        ...
        regex:
          source: '\S'
          error: "Error field cennot be empty"
...
After plugin installed user sees additional elements on Fuel web UI
on **Settings** tab:
...
from **/etc/astute.yaml** file, in our case plugin specific data look like:
