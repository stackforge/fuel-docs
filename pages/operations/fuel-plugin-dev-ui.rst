...
When the user runs deployment, the plugin deployment script can get the data
from the */etc/astute.yaml* file; in this example, plugin-specific data look like:
