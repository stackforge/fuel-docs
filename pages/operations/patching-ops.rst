...
This section describes how to apply, rollback, and verify the packages applied
...
* The changes that the patches introduce will applied to the new OpenStack
  environments. The changes will not be applied to the existing environments.
...
Installing an OpenStack environment with the latest packages
------------------------------------------------------------

When you deploy a new environment, the latest updates are applied to that
environment.

Verifying the packages on the Fuel Master node
----------------------------------------------
...
# Log in to the Fuel Master nod CLI.
# Type:
...
Verifying the packages on the Fuel Slave nodes
----------------------------------------------
