...
document, and the :ref:`fuel-dev-quick-start`
which illustrate the development
...
* :ref:`Architecture section of Fuel documentation<fuel-arch-dev>`
* :ref:`Visual of provisioning tasks<sequence-fuel-dev>`
...
additional role to :ref:`Nailgun<nailgun-dev>`. The
