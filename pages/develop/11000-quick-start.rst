...
#. Modify the necessary files
   (refer to :ref:`fuel-arch-dev`
   to understand how the components of Fuel work together).
...
#. Now that your code has been committed, you should change
   ...
   As noted in the :ref:`dev-environment-dev`,
...
#. Once your ISO build is complete, you can test it.  If
   ...
   :ref:`devops-dev` to create a robust testing
