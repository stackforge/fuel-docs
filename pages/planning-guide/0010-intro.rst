...
You can install Fuel master node on vSphere and deploy a Mirantis OpenStack Environment either on baremetal or on vSphere as well.
It is discussed in :ref:`Installing Fuel Master Node on vSphere<fuel-on-vsphere-ug>`.
