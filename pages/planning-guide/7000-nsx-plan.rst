...
VMware NSX documentation states that an NSX cluster can operate successfully
without an NSX Service node, but its presence is mandatory for deploying
Mirantis OpenStack with NSX.
