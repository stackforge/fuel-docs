...
nodes must support nested virtualization and have it enabled.
VirtualBox does not support nested virtualization, and as a result
environments deployed by :ref:`virtualbox` will have Sahara working
poorly.
