...
Plug-ins are located in different directories of the storage
...
* Installation instructions (for documentation template, see)
...
* Developer Guide in .pdf format should be provided. It must
  ...
  - Access to the plug-in developer'stest lab
