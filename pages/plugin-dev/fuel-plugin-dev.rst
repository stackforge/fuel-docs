...
For instructions, see <add the link>
...
Task with type *puppet* allows you to apply your own puppet manifests on OpenStack nodes. Also see section ADD REFERENCE *Puppet in Fuel* (eli: Irina, could you please help to make a link to the section, do I need to define a label?)
