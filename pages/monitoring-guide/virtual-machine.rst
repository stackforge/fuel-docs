...
Instance metrics
----------------
Is possible to retrieve guests stats from libvirt, see libvirt-domain_ for details
...
it runs.
Unfortunately, there are not support of guest agent with KVM hypervisor at this time,
