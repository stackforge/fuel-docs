...
requiring a deep understanding of all the OpenStack components.
Fuel enables a system administrator to provision an OpenStack single node
as well as a clustered cloud in an hour or so,
