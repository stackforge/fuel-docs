...
* Now it is not possible to deploy OpenStack with vCenter without specifying vCenter credentials.
...
* CentOS and Ubuntu packages were provided for Ceph v0.80.1;ceph-deploy packages were updated to 1.5.2.
