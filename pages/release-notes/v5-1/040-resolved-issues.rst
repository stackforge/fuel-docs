...
* The OSD prepare step of Ceph deployment is now performed successfully.
...
* Optional parameters ere added to create backing methods so that a backing VM can be created without a
