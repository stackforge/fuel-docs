...
users will be asked to provide authentication credentials (e.g. username and password).
...
More information on setting and updating the usernames and passwords
for the system can be found in the online documentation.

Mirantis OpenStack now deploys the ML2 Open vSwitch plugin for Neutron
----------------------------------------------------------------------
Starting with Havana, the legacy plugin structure for Neutron
...
experimental features ar disabled by default
