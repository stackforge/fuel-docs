...
* If NSX cluster resides in separate network that have L3 connectivity with
  OpenStack Public network, you must enable Public addresses assignment for all
  nodes, check :ref:`neutron-nsx-arch`.
