...
There is a bug in the Oslo messaging affecting MOS HA environments.
The bug appears like OpenStack either works unstable and the instability
increases with load increase. A lot of broken AMQP connections and Oslo
related errors appear in different logs.
