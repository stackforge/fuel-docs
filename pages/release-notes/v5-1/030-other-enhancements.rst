...
- Configure storage to work over :ref:`iser-term` (High performance iSCSI protocol over :ref:`rdma-term`)
- Install OFED drivers, firmware and configure :ref:`sr-iov-term` kernel parameters
