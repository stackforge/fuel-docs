...
neutron-server Service could not start
--------------------------------------

Puppet logs reported that the neutron-server Service could not start.
This was because the version of the software
was not being set in the empty Neutron database
before data was added and
before attempting to start the neutron-server Service.
This has been fixed.
See `LP13248591324859 <https://bugs.launchpad.net/fuel/+bug/1324859>`_.
