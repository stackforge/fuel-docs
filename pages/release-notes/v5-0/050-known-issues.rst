...
Additional phython eggs on the Master Node
...
see `HA Improvements of pacemaker and corosoyn <https://blueprints.launchpad.net/fuel/+spec/ha-pacemaker-improvements>`_
for a description of changes hat are planned for future releases.. 
