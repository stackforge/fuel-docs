...
* A new option *Abandon Environment* is added to Murano. Therefore, now you
  can stop a deployment in case of an emergency or remove an environment that
  fails to deploy. This option is available on the *Environments* page, as
  well as through Murano CLI and API. See `LP1442910`_.
