...
.. csv-table:: **Major components versions**
   ...
   | Ubuntu 14.04 (x86_64 architecture only)"
   "**Hypervisor**", "| Ubuntu: KVM, `libvirt 1.2.9`_; QEMU 2.0.0 (the latter is coming from upstream OpenStack)
...
.. _`Ceph 0.80.9 Firefly`: http://ceph.com/docs/master/release-notes/#v0-80-7-firefly
