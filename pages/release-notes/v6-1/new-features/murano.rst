...
* Users can source Murano packages and their dependencies using a URL
  ...
  See `the related blueprint <https://blueprints.launchpad.net/murano/+spec/muraniclient-url-download>`_.

* Support for Docker applications in Murano.
  See `the related blueprint <https://blueprints.launchpad.net/murano/+spec/docker-registry-in-murano>`_.
