...
* :ref:`LP1463802 <mos61mu-1463802>` RPC clients cannot find a reply
  queue after the last RabbitMQ server restarts in the cluster

* :ref:`LP1466490 <mos61mu-1466490>` Neutron L2 agent performs a DoS
  because of incorrectly allowed address pairs

* :ref:`LP1462991 <mos61mu-1462991>` [libvirt] Handle empty context
  on _hard_reboot

* :ref:`LP1462991 <mos61mu-1466552>` CentOS radosgw doesn't start
  after reboot

* :ref:`LP1462991 <mos61mu-1469149>` backend_argument containing a
