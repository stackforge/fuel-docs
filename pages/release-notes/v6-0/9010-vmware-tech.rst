...
* In HA mode for CentOS and Ubuntu OS, 'Launch instance' OSTF test fails because creation of an
  instance requires more then 300 seconds allowed for the OSTF timeout for this test.
...
* Fuel allows you to deploy Compute nodes although they are not
  supported when vCenter is used as the hypervisor.
