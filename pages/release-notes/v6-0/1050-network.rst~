...
* Neutron GRE fails in CentOS with timeout error.
  See `LP1382529 <https://bugs.launchpad.net/bugs/1382529>`_.

* RPC errors occur in Neutron ovs agent. See
  `LP1379257 <https://bugs.launchpad.net/bugs/1379257>`_.

* Multiple floating ranges do not working when using Neutron.
