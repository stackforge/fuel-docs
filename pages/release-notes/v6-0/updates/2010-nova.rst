...
* If you resize an existing instance to a larger flavor and later
  ...
  processes running against particular instances. Therefore, now
...
* In case of nova-compute failover, it creates a new folder to obtain
  cached images and downloads them again. It happens if nova-compute
  is used with VMWare vCenter and the :option:`remove_unused_base_images`
  option is set.
