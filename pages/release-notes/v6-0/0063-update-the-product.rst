...
.. warning:: Updating Mirantis OpenStack deployment could override
   manually applied customer's patches and cause restarting of OpenStack services.
...
.. note::
      After updating OpenStack services will be automatically rebooted by script in package.
      In some cases there is a need in a manual restart of some services after updating.
      Please consider a full manual restart of all OpenStack services after update with a downtime.
