...
document, and the :ref:`Fuel Development Quick-Start Guide
<fuel-dev-quickstart>` which illustrate the development
...
* :ref:`Architecture section of Fuel documentation <fuel-architecture>`
* :ref:`Visual of provisioning tasks <sequence-diagrams>`
...
additional role to :ref:`Nailgun <nailgun>`. The
