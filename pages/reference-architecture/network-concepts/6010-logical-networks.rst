...
Public Network
  ...
  networks onto one NIC, Public network is best left untagged on that NIC. This
  is not a requirement, but will simplify external access to OpenStack
  Dashboard and public OpenStack API endpoints.
