...
Implementing a Multiple Cluster Networks (MCN)
==============================================

A Multiple Cluster Network (MCN) is used for environments
...
A Multiple Cluster Network can be configured
...
This section discusses how support for a Multiple Cluster Networks is implemented.
:ref:`mcn-ops` tells how to configure this feature
for your Fuel environments.

A Multiple Cluster Network is based on
