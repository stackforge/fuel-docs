...
# Should allow you to specify a target or commit when cloning fuel-web repo
# so version-specific documentation will pull in matching version from
# fuel-web so autogenerated API docs match the rest of the docs
getfuelweb:
	mkdir -p $(BUILDDIR)/repos
	rm -rf $(BUILDDIR)/repos/fuel-web
	cd $(BUILDDIR)/repos && git clone https://github.com/stackforge/fuel-web.git

all: clean html dirhtml singlehtml latexpdf pdf

html: getfuelweb images
	$(SPHINXBUILD) -b html -W $(ALLSPHINXOPTS) $(BUILDDIR)/html
	@echo
	@echo "Build finished. The HTML pages are in $(BUILDDIR)/html."

dirhtml: getfuelweb iimages
	$(SPHINXBUILD) -b dirhtml $(ALLSPHINXOPTS) $(BUILDDIR)/dirhtml
	@echo
	@echo "Build finished. The HTML pages are in $(BUILDDIR)/dirhtml."

singlehtml: getfuelweb iimages
...
htmlhelp: getfuelweb iimages
	$(SPHINXBUILD) -b htmlhelp $(ALLSPHINXOPTS) $(BUILDDIR)/htmlhelp
	@echo
	@echo "Build finished; now you can run HTML Help Workshop with the" \
	      ".hhp project file in $(BUILDDIR)/htmlhelp."

qthelp: getfuelweb iimages
...
epub: getfuelweb iimages
	$(SPHINXBUILD) -b epub $(ALLSPHINXOPTS) $(BUILDDIR)/epub
	@echo
	@echo "Build finished. The epub file is in $(BUILDDIR)/epub."

latex: getfuelweb iimages
